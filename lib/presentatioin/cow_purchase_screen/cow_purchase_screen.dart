...
class CowPurchaseScreen extends StatelessWidget {
  const CowPurchaseScreen({super.key});
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          // const Text(AppStrings.phonetext),
                          ElevatedButton(
                            onPressed: () {
                    ...
                    // second container cow information
                ...
                BottomNavigationBar(
                  ...
                  selectedIconTheme: const IconThemeData(
                      color: Colors.purple), // Set the color for selected items
                  unselectedIconTheme: const IconThemeData(
                      color: AppColors
                          .grayColor), // Set the color for unselected items
                  backgroundColor: Colors
                      .black, // Set the background color of the entire BottomNavigationBar
                ),
              ],
            ),
          ),
